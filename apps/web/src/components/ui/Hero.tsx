    ...
    return (
        <>
            ...
            <div ref={homeRef} className="hero flex flex-col items-center justify-center h-screen">
                ...
                <Button onClick={() => { router.push("/train") }} className="mt-5 bg-white text-black rounded-2xl hover:bg-white hover:underline transition-transform duration-300">Discover More
                </Button>
            </div>
        </>
    )
